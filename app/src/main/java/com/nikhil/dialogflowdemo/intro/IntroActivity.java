...
public class IntroActivity extends BaseActivity {
    ...
    private void addBottomDots(int currentPage) {
        ...
        int colorsActive = ContextCompat.getColor(this, R.color.primary_light);
        int colorsInactive = ContextCompat.getColor(this, R.color.primary_dark);
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(IntroActivity.this, AgentsActivity.class));
        finish();
    }
